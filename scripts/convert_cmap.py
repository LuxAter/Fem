...
def main():
    # result = "std::vector<std::array<double, 3>> magma{"
    # for rgb  in _magma_data:
    #     result += "{{{{{}, {}, {}}}}},".format(rgb[0], rgb[1], rgb[2])
    # result = result[:-1] + "};"
    # print(result)
    # result = "std::vector<std::array<double, 3>> inferno{"
    # for rgb  in _inferno_data:
    #     result += "{{{{{}, {}, {}}}}},".format(rgb[0], rgb[1], rgb[2])
    # result = result[:-1] + "};"
    # print(result)
    # result = "std::vector<std::array<double, 3>> plasma{"
    # for rgb  in _plasma_data:
    #     result += "{{{{{}, {}, {}}}}},".format(rgb[0], rgb[1], rgb[2])
    # result = result[:-1] + "};"
    # print(result)
    # result = "std::vector<std::array<double, 3>> viridis{"
    # for rgb  in _viridis_data:
    #     result += "{{{{{}, {}, {}}}}},".format(rgb[0], rgb[1], rgb[2])
    # result = result[:-1] + "};"
    # print(result)
