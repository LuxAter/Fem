...
def convert_data(name, data):
    cmap = LinearSegmentedColormap.from_list('parula', data)
    data = [list(cmap(x))[:-1] for x in range(256)]
    print("{{\"{}\", {{{{".format(name))
    for color in data:
        print(
...
def main():
    print("static std::map<std::string, std::array<uint32_t, 256>> _cmaps = {")
    convert_data(
        "parula",
        [[0.2081, 0.1663, 0.5292], [0.2116238095, 0.1897809524, 0.5776761905],
         [0.212252381, 0.2137714286, 0.6269714286],
         [0.2081, 0.2386, 0.6770857143], [0.1959047619, 0.2644571429, 0.7279],
         ...
         [0.609852381, 0.7473142857, 0.4336857143], [0.6473, 0.7456, 0.4188],
         ...
         [0.988, 0.806600000, 0.1793666667],
