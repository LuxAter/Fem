...
fem::image::Figure1D::Figure1D()
    : width_(0),
      height_(0),
      color_(0),
      bounds_({{INFINITY, INFINITY, -INFINITY, -INFINITY}}) {}
fem::image::Figure1D::Figure1D(const uint64_t& w, const uint64_t& h)
    : width_(w),
      height_(h),
      color_(0),
      bounds_({{INFINITY, INFINITY, -INFINITY, -INFINITY}}) {}

fem::image::Figure1D::Figure1D(const Figure1D& copy)
    : width_(copy.width_),
...
void fem::image::Figure1D::SaveSvg(const std::string& file) {
...
void fem::image::Figure1D::PlotScatter(
...
void fem::image::Figure1D::PlotLine(
    Svg& svg,
