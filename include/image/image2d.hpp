...
namespace image {
  class Image2D : public Image {
   public:
    ...
    void Triangle(const std::array<std::size_t, 3>& tri, const std::vector<std::array<double, 2>>& points, uint32_t color=0xfffff);
    ...
    void Circle(const std::array<double, 2>& pt, int32_t r, uint32_t color=0xffffff);
