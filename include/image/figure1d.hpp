#ifndef FEM_IMAGE_FIGURE1D_HPP_
#define FEM_IMAGE_FIGURE1D_HPP_
...
namespace image {
  ...
  class Figure1D {
   public:
    Figure1D();
    Figure1D(const uint64_t& w, const uint64_t& h);
    Figure1D(const Figure1D& copy);
